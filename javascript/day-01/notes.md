...
Today I learned the first basics of JavaScript.

## What I learned
- I learned how to print text to the console using `console.log()`.
- I practiced writing simple messages such as "Hello, World!" and "Hello, Elbasry!".
- I learned about variables and how they store data for later use.
- I studied the difference between `var`, `let`, and `const`:
